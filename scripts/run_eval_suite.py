#!/usr/bin/env python3
"""Execute with-skill and baseline evals in parallel.

When to use: Phase 3 (Evaluate & Iterate). After eval workspace and test cases
are ready. Runs both conditions concurrently to minimize wall-clock time.

Why: Parallel execution prevents the evaluator from anchoring on one condition
first; also enforces the statistical rigor of blind comparison.
"""
