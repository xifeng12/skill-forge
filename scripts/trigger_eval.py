#!/usr/bin/env python3
"""Measure description trigger accuracy and hijacking risk.

When to use: Phase 4 (Harden & Gate) or continuous monitoring. Feeds a set of
positive and negative prompts to the skill description and scores routing
precision.

Why: A skill with poor trigger discrimination creates hijacking — it fires on
unrelated prompts, wasting context and confusing the agent. This gate ensures
trigger quality >= 90%.
"""
