#!/usr/bin/env python3
"""Aggregate eval results across iterations into confusion matrix.

When to use: End of Phase 3 or before Phase 4. Summarizes true/false positives
and negatives across all test prompts and iterations.

Why: A single accuracy score hides failure modes. The confusion matrix reveals
whether the skill is over-triggering (false positives) or under-triggering
(false negatives), guiding targeted fixes.
"""
