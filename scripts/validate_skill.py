#!/usr/bin/env python3
"""Pre-gate structural validation before hardening.

When to use: Phase 4 (Harden & Gate), as the first lightweight gate. Checks
SKILL.md syntax, frontmatter completeness, and reference file reachability.

Why: Catches trivial structural errors before expensive evals or governance
gates run, failing fast and saving iteration time.
"""
