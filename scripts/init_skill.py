#!/usr/bin/env python3
"""Scaffold a new skill directory from archetype template.

When to use: Phase 2 (Draft & Scaffold). Called after intent is captured and
mode/archetype are selected. Generates the minimal working directory structure
including SKILL.md frontmatter, references/, scripts/, and evals/.

Why: Ensures every new skill starts from a consistent, validated template
rather than ad-hoc creation, reducing structural drift across the skill fleet.
"""
